...
Bu kısa rehber HasarBotu v0.6.0'nin canlı ofis kullanımında izlenecek günlük akışı özetler. Detaylı anlatım için [KULLANIM_KILAVUZU.md](KULLANIM_KILAVUZU.md) kullanılır.
...
- İşçilik Excel'leri AI Otomatik İşçilik Dağıtıcı ile önce önizlemeye alınır.
