...
HasarBotu v0.6.0 Windows dağıtımı Electron Builder ile üretilir. Release çıktıları `release/` klasöründe tutulur.
...
| Çıktı | Amaç |
| --- | --- |
| `HasarBotu-Baran-Ekspertiz-Kurulum-0.6.0.exe` | NSIS kurulum paketi |
| `HasarBotu-Baran-Ekspertiz-Tasinabilir-0.6.0.exe` | Taşınabilir uygulama |
...
- [ ] Ofis hedef sürüm v0.6.0 olarak ayarlandı.
