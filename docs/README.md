...
Bu klasör HasarBotu v0.4.12 için kullanım, kurulum, veri güvenliği, Excel/AI işçilik dağıtımı ve ofis release süreçlerini tek merkezde toplar.
...
| [CHANGELOG.md](CHANGELOG.md) | v0.4.12 dokümantasyon ve ürün özeti | Tüm ekip |

## Uyumluluk İçin Korunan Dokümanlar

Bazı eski dosya adları audit ve saha kabul komutları tarafından beklenir. Bu dosyalar silinmez; içerikleri v0.4.12 ile uyumlu tutulur.
...
| [V0.4.0_PRODUCTION_CANDIDATE.md](V0.4.0_PRODUCTION_CANDIDATE.md) | Audit uyumlu üretim adayı notu; içerik v0.4.12'ye göre günceldir |
...
- Sürüm referansı v0.4.12 olarak tutulur.
