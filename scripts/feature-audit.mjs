...
const checks = [
  ...
  ['Renderer eski işçilik Excel kartı gizli', 'src/renderer/app/components/detail.ts', 'labor-excel-card" hidden aria-hidden="true"'],
  ['Renderer AI otomatik işçilik ana kartı', 'src/renderer/app/components/detail.ts', 'AI Otomatik İşçilik Dağıtıcı'],
